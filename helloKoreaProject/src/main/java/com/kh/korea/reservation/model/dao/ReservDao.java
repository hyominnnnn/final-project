...
import com.kh.korea.reservation.model.vo.Program;
...
public class ReservDao {
	...
	public String selectPrice(SqlSessionTemplate sqlSession, String programNo) {
		return sqlSession.selectOne("reservMapper.selectPrice", programNo);
	}
